...
d_2018 <- read.csv("raw_data/africabar_2018.csv") %>%
  ...
  select(year, country_code, respno, urban, gender, direction_country, current_eco,
         ...
         sat_dem, unfair, election_fair, import_prob1, import_prob2, import_prob3)
...
# Read in World Bank population dataset.
...
# reading in world bank gdp data
...
# Making the graphs for showing direction, year on year, and country by year
...
# all countries, general direction economics and livelihood 2018
...
# all countries, general direction economics and livelihood 2013
